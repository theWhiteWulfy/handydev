...
const APIPage: ToolPage = () => (
  <>
    <h2>Tool List</h2>
    <p>
      Handydev.tools provides an endpoint to list all available tools, including
    ...
    <p>
      <code>
        <Link href="/json?sidebar=off">
          https://handydev.tools/json?sidebar=off
        </Link>
      </code>
    </p>
    <p>
      <code>
        <Link href="/json?sidebar=off&amp;footer=off">
          https://handydev.tools/json?sidebar=off&amp;footer=off
        </Link>
      </code>
    </p>
    <p>
      <code>
        <Link href="/json?sidebar=off&amp;line-numbers=off">
          https://handydev.tools/json?sidebar=off&amp;line-numbers=off
        </Link>
      </code>
    </p>
    <h2>Tips</h2>
